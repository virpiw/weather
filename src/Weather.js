...
export default class Weather extends React.Component {
  ...
  render() {
    const { temperature, feels, min, max, wind_speed, wind_direction, description, icon } = this.state;
...
// GPS coordinates of Oulu, Finland. Latitude: 65.0124 Longitude: 25.4682
// http://api.openweathermap.org/data/2.5/weather?lat=65.012&lon=25.468&units=metric&appid=a4382cb8a2ba16680ee17d1806dfafae